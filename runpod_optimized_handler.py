"""
RunPod Optimized Handler for Northeastern University Chatbot
GPU-accelerated RAG with optimized performance for 5-8 second response times
"""
...
print("=" * 80)
print("🚀 RUNPOD OPTIMIZED - Northeastern University Chatbot")
print("=" * 80)
...
class OptimizedNortheasternChatbot:
    """GPU-optimized RAG chatbot for Northeastern University with performance optimizations"""
    
    def __init__(self):
        """Initialize the chatbot with optimized settings"""
        print("\n[INIT] Initializing Optimized Northeastern Chatbot...")
    ...
    def search_documents_optimized(self, query: str, n_results: int = 8) -> List[Dict]:
        """Optimized document search with concurrent processing"""
        try:
...
Answer:"""
    ...
    def chat(self, question: str) -> Dict[str, Any]:
        """Optimized chat function for 5-8 second response times"""
        start_time = time.time()
...
print("\n[STARTUP] Initializing optimized chatbot instance...")
chatbot = None

try:
    chatbot = OptimizedNortheasternChatbot()
    print("✅ Optimized chatbot instance created successfully")
except Exception as e:
...
def handler(event: Dict[str, Any]) -> Dict[str, Any]:
    """
    RunPod serverless handler function - Optimized for 5-8 second response times
...
if __name__ == "__main__":
    print("\n" + "=" * 80)
    print("🚀 Starting RunPod Optimized Serverless Handler")
    print("=" * 80)
