...
# Lambda Labs GPU Deployment Script - REVAMPED VERSION
# Northeastern University Chatbot - Ultra-Fast GPU Deployment
# AVOIDS SYSTEM RESTARTS AND JUPYTER INTERFERENCE

set -e  # Exit on any error

echo "🚀 LAMBDA LABS GPU DEPLOYMENT - REVAMPED"
echo "========================================="
echo "✅ Avoiding system restarts to preserve Jupyter"
echo ""
...
# Create startup script (no systemd service to avoid conflicts)
...
main() {
    print_status "Starting Lambda Labs GPU deployment (REVAMPED)..."
    echo ""
